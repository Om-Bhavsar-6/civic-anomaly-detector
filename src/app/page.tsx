...
import { Trophy, Zap, Users, PlusCircle } from "lucide-react";
...
const placeholderReports: Report[] = [
  {
    ...
    description:
      "A large pothole near the metro station is causing traffic issues.",
  ...
  },
  {
    ...
    description:
      "Graffiti was spray-painted on the front wall of the Vishal Mega Mart in Connaught Place.",
      ...
      <div className="space-y-12 w-full">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Our platform empowers you to report civic issues like potholes and
            graffiti in real-time. Join thousands of community members making a
            difference.
          </p>
