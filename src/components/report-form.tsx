...
import {
  detectAnomaly,
  type DetectAnomalyOutput,
} from "@/ai/flows/detect-anomaly-flow";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export function ReportForm() {
  ...
  const [analysisResult, setAnalysisResult] =
    useState<DetectAnomalyOutput | null>(null);
                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      For unresolved issues, you can contact the Ministry of
                      Road Transport and Highways (MoRTH):
                    </p>
                    <div className="space-y-2 text-sm">
                      <p className="flex items-center gap-2">
                        <Phone className="h-4 w-4" /> Phone: 011-23351280 (Fax
                        also)
                      </p>
                      <p className="flex items-center gap-2">
                        <Mail className="h-4 w-4" /> Email: wim.rth@nic.in
                      </p>
                      <p className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-4 pt-1">
                        ...
                        <a
                          href="https://morth.gov.in/contact-us"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                        ...
                        <a
                          href="https://morth.gov.in/about-us"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                        ...
                        <a
                          href="https://morth.nic.in/who-is-who"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
